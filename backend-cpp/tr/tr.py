...
# 前两个参数为int，传入0 1
# 第三个参数是图片矩阵的首地址
# 第456个参数是：H, W, Channel，要么1要么3
# 第7个参数是ROTATE参数
# 第八个是空指针，大小是max_lines * RECT_SIZE，第九个是max_lines
# 第十个是空指针，大小是max_lines * max_width，类型是int32
# 第十一个是空指针，大小是max_lines * max_width，类型是float32
# 第十二个是max_width
